...
@onready var new_symbol_label: Label = %NewSymbolLabel
@onready var option_button: OptionButton = $VBoxContainer/MarginContainer/VBoxContainer/HBoxContainer3/OptionButton
@onready var labelHP: Label = $VBoxContainer/MarginContainer/VBoxContainer/HBoxContainer/Label
@onready var labelPoint: Label = $VBoxContainer/MarginContainer/VBoxContainer/HBoxContainer2/Label
...
func setup(formation: FormationResource, context: Dictionary) -> void:
	...
	new_symbol_label.text = "Enemy: " + new_symbol 
...
func _on_confirmed() -> void: # тут надо переделать на на хуй знает что?
